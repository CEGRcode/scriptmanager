...
public class ScriptManagerCLI implements Callable<Integer> {
	
	@Override
	public Integer call(){
		
		System.out.println( "Use '-h' or '--help' for command-line usage guide" );
		ScriptManager gui = new ScriptManager();
	...
	public static void main(String[] args) {
		...
		CommandLine cmd = new CommandLine( new ScriptManagerCLI() );
		cmd.execute(args);

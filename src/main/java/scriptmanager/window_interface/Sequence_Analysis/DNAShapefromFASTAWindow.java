		...
		public Void doInBackground() {
			try {
				if (FASTAFiles.size() < 1) {
					...
					DNAShapefromFASTAOutput output_obj = new DNAShapefromFASTAOutput(FASTAFiles, OUT_DIR, OUTPUT_TYPE, ckbxOutputAverages.isSelected(), chckbxGzipOutput.isSelected());

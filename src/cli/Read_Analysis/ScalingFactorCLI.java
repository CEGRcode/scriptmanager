...
public class ScalingFactorCLI implements Callable<Integer> {
	...
	@Parameters( index = "0", description = "The BAM file from which we calculate ___________fill in this language later_________________.")
	...
	public Integer call() throws Exception {
		...
		System.err.println( "OUT" + outputBasename );
...
// 				System.err.println("default to current directory");
		...
		if(controlBAM==null && scaleType!=1){
			r += "(!)Control file must be given when using NCIS-related scaling methods\n";
		}

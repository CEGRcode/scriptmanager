...
public class ScaleMatrixWindow extends JFrame implements ActionListener, PropertyChangeListener {
	...
	public ScaleMatrixWindow() {
        ...
        btnOutput.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
    			...
    			if(OUTPUTPATH != null) { lblDefaultToLocal.setText(OUTPUTPATH.getAbsolutePath()); }
        	}
        });
        ...
        sl_contentPane.putConstraint(SpringLayout.NORTH, rdbtnUniformScaling, 0, SpringLayout.NORTH, rdbtnFilespecifcScaling);
        sl_contentPane.putConstraint(SpringLayout.EAST, rdbtnUniformScaling, -32, SpringLayout.WEST, rdbtnFilespecifcScaling);
        ...
        sl_contentPane.putConstraint(SpringLayout.WEST, lblUniformScalingFactor, 0, SpringLayout.WEST, rdbtnUniformScaling);
	...
	/**
	 * Adapted from: https://www.javaworld.com/article/2077579/learn-java/java-tip-77--enable-copy-and-paste-functionality-between-swing-s-jtables-and-excel.html
	...
	public class ExcelAdapter implements ActionListener {
	   ...
	   public ExcelAdapter(JTable myJTable) {
	      ...
	      // Identifying the Paste KeyStroke user can modify this to copy on some other Key combination.
	    ...
	    * Paste is done by aligning the upper left corner of the selection with the 1st element in the current selection of the JTable.
	    */
	   public void actionPerformed(ActionEvent e) {
	          ...
	          try {
	             ...
	             for(int i=0;st1.hasMoreTokens();i++) {
	                ...
	                for(int j=0; st2.hasMoreTokens(); j++) {
	                   ...
	                   if (startRow+i< jTable1.getRowCount()  && startCol+j< jTable1.getColumnCount() && jTable1.isCellEditable(startRow+i, startCol+j)) { jTable1.setValueAt(value,startRow+i,startCol+j); }

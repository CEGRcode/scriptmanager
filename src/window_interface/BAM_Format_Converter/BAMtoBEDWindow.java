        ...
        public Void doInBackground() throws IOException, InterruptedException {
        	try {
        		if(chckbxFilterByMinimum.isSelected() && Integer.parseInt(txtMin.getText()) < 0) {
		        	...
		        	else if(rdbtnMidpoint.isSelected()) { STRAND = 3; }
		        	else if(rdbtnFragment.isSelected()) { STRAND = 4; }
	...
	public BAMtoBEDWindow() {
        ...
        rdbtnMidpoint.addItemListener(new ItemListener() {
		      public void itemStateChanged(ItemEvent e) {
			        ...
			        } else if(!chckbxFilterByMinimum.isSelected() && !chckbxFilterByMaximum.isSelected()) { chckbxRequireProperMatepair.setEnabled(true); }
			      }
			    });
        ...
        chckbxFilterByMinimum.addItemListener(new ItemListener() {
		      public void itemStateChanged(ItemEvent e) {
			        if(chckbxFilterByMinimum.isSelected()) {
			        	...
			        	if(!chckbxFilterByMaximum.isSelected() && !rdbtnMidpoint.isSelected() && !rdbtnFragment.isSelected()) { chckbxRequireProperMatepair.setEnabled(true); }
			        }
			      }
			    });
        ...
        chckbxFilterByMaximum.addItemListener(new ItemListener() {
		      public void itemStateChanged(ItemEvent e) {
			        if(chckbxFilterByMaximum.isSelected()) {
			        	...
			        	if(!chckbxFilterByMinimum.isSelected() && !rdbtnMidpoint.isSelected() && !rdbtnFragment.isSelected()) { chckbxRequireProperMatepair.setEnabled(true); }
			        }
			      }
			    });

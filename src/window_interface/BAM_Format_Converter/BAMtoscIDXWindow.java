        ...
        chckbxFilterByMinimum.addItemListener(new ItemListener() {
		      public void itemStateChanged(ItemEvent e) {
			        if(chckbxFilterByMinimum.isSelected()) {
			        	...
			        	if(!chckbxFilterByMaximum.isSelected() && !rdbtnMidpoint.isSelected()) { chckbxRequireProperMatepair.setEnabled(true); }
			        }
			      }
			    });
        ...
        chckbxFilterByMaximum.addItemListener(new ItemListener() {
		      public void itemStateChanged(ItemEvent e) {
			        if(chckbxFilterByMaximum.isSelected()) {
			        	...
			        	if(!chckbxFilterByMinimum.isSelected() && !rdbtnMidpoint.isSelected()) { chckbxRequireProperMatepair.setEnabled(true); }
			        }
			      }
			    });

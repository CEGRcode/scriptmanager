...
import scripts.GeneTrackBAM;

@SuppressWarnings("serial")
public class GeneTrackBAMWindow extends JFrame implements ActionListener, PropertyChangeListener {
        	...
        	try {
				if(Integer.parseInt(txtSigma.getText()) < 1) {
		        	...
		        	for(int x = 0; x < BAMFiles.size(); x++) {       		
		        		GeneTrackBAM track = new GeneTrackBAM(BAMFiles.get(x), SIGMA, EXCLUSION, UP, DOWN, FILTER);
